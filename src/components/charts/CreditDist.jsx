...
export default function CreditDist({ data, totalCourses }) {
  const colors = ['#6366F1', '#10B981', '#F5A623', '#EF4444', '#06B6D4', '#8B5CF6'];
  ...
  const centerTextPlugin = {
    ...
    beforeDraw: (chart) => {
      ...
      ctx.fillText('COURSES', centerX, centerY - 12);
  ...
  return (
    <div className="chart-card">
      <div className="chart-card-title">학점 구성 비율</div>
